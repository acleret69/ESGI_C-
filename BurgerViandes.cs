...
public class BurgerViandes : Burger
{
    public BurgerViandes(string nom, string temps, int température, string typeCuisson) : base( nom,  temps,  température,  typeCuisson)
    {
    ...
    {
        Console.WriteLine("Recette burger : ");
