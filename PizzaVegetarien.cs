...
public class PizzaVegetarien : Pizza
{
    public PizzaVegetarien(string nom, string temps, int température, string typeCuisson) : base( nom,  temps,  température,  typeCuisson)
    {
    ...
    {
        Console.WriteLine("Recette pizza Végétarien : ");
